...
class DesStreamJsonTest {
    ...
    void uppercaseFilterTest()
        ...
        JsonNode node2 = mapper.readValue("{'table':'DBSCHEMA.CABOT_COVE_CUSTOMERS', 'op_type':'I', 'op_ts':'2019-10-16 17:34:20.000534', 'current_ts':'nowTimestamp()', 'pos':'randomIncrementLong(two, 00000000000000000000000000,1, 5000)', 'before':{ 'ORDERS_STATUS_HISTORY_ID':'counter(one)', 'ORDERS_ID':7, 'ORDERS_STATUS':0, 'DATE_ADDED':'2016-06-16:13:32:23.172212000', 'CUSTOMER_NOTIFIED':1, 'COMMENTS':'Order received, customer notified' }, 'after':{ 'ORDERS_STATUS_HISTORY_ID':'counter(one)', 'ORDERS_ID':7, 'ORDERS_STATUS':1, 'DATE_ADDED':'2016-06-16:13:32:23.172212000', 'CUSTOMER_NOTIFIED':1, 'COMMENTS':'Order received, customer notified'}}", JsonNode.class);
