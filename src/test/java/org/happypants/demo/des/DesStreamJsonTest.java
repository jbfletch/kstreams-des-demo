...
class DesStreamJsonTest {
    ...
    void cdcFilterMapTest()
        ...
        JsonNode node2 = mapper.readValue("{'table':'DBSCHEMA.CABOT_COVE_ORDERS', 'op_type':'U', 'op_ts':'2019-10-16 17:34:20.000534', 'current_ts':'2019-09-16 17:34:20.000534', 'pos':'00000000000000000000000042', 'before':{ 'ORDERS_STATUS_HISTORY_ID':'41', 'ORDERS_ID':'null', 'ORDERS_STATUS':0, 'DATE_ADDED':'2016-06-16:13:32:23.172212000', 'CUSTOMER_NOTIFIED':1, 'COMMENTS':'Order received, customer notified' }, 'after':{ 'ORDERS_STATUS_HISTORY_ID':'42', 'ORDERS_ID':7, 'ORDERS_STATUS':1, 'DATE_ADDED':'2016-06-16:13:32:23.172212000', 'CUSTOMER_NOTIFIED':1, 'COMMENTS':'Order received, customer notified'}}", JsonNode.class);
