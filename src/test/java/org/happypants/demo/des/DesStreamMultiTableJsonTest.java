...
class DesStreamMultiTableJsonTest {
    ...
    void cdcItemBlockerTest()
        ...
        JsonNode node3 = mapper.readValue("{'table':'DBSCHEMA.CABOT_COVE_ORDER_LINES', 'op_type':'I', 'op_ts':'2019-10-16 17:34:20.000534', 'current_ts':'2019-09-16 17:34:20.000534', 'pos':'00000000000000000000000042', 'after':{ 'ORDERS_LINE_STATUS_HISTORY_ID':'42', 'ORDER_ITEM_ID':18, 'ORDER_ID':7, 'ORDERS_LINE_STATUS':1, 'DATE_ADDED':'2016-06-16:13:32:23.172212000', 'ITEM_COMMENTS':'Scooters are the best'}}", JsonNode.class);
        JsonNode node4 = mapper.readValue("{'table':'DBSCHEMA.CABOT_COVE_ORDER_LINES', 'op_type':'I', 'op_ts':'2019-10-16 17:34:20.000534', 'current_ts':'2019-09-16 17:34:20.000534', 'pos':'00000000000000000000000042', 'after':{ 'ORDERS_LINE_STATUS_HISTORY_ID':'42', 'ORDER_ITEM_ID':19, 'ORDER_ID':7, 'ORDERS_LINE_STATUS':1, 'DATE_ADDED':'2016-06-16:13:32:23.172212000', 'ITEM_COMMENTS':'High-Tops are the best'}}", JsonNode.class);
        JsonNode node5 = mapper.readValue("{'table':'DBSCHEMA.CABOT_COVE_ORDER_LINES', 'op_type':'I', 'op_ts':'2019-10-16 17:34:20.000534', 'current_ts':'2019-09-16 17:34:20.000534', 'pos':'00000000000000000000000042', 'after':{ 'ORDERS_LINE_STATUS_HISTORY_ID':'42', 'ORDER_ITEM_ID':20, 'ORDER_ID':7, 'ORDERS_LINE_STATUS':1, 'DATE_ADDED':'2016-06-16:13:32:23.172212000', 'ITEM_COMMENTS':'Comics are the best'}}", JsonNode.class);
        JsonNode node6 = mapper.readValue("{'table':'DBSCHEMA.CABOT_COVE_ORDER_LINES', 'op_type':'D', 'op_ts':'2019-10-16 17:34:20.000534', 'current_ts':'2019-09-16 17:34:20.000534', 'pos':'00000000000000000000000042', 'before':{ 'ORDERS_LINE_STATUS_HISTORY_ID':'42', 'ORDER_ITEM_ID':20, 'ORDER_ID':7, 'ORDERS_LINE_STATUS':1, 'DATE_ADDED':'2016-06-16:13:32:23.172212000', 'ITEM_COMMENTS':'Comics are the best'}}", JsonNode.class);


        /* This is a fun place to switch up the order of sending and see how that impacts things :-)  */

        this.testTopology.input("DBSCHEMA.CABOT_COVE_ORDER_LINES")
                .add(null,node3)
                .add(null,node4)
                .add(null,node5);
