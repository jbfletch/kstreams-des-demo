...
class OneToOneJoinProcessorTest {
    ...
    private final OneToOneJoinProcessorApi app = new OneToOneJoinProcessorApi();
    ...
    void oneToOneJoinTest()
        ...
        this.testTopology.input("sample-uppers-topic")
                .add("RED", "One");

        this.testTopology.input("sample-bases-topic")
                .add("RED","1")
                .add("RED","2")
                .add("RED","3");
...
//                .add(null,node6); // Delete to demonstrate tombstoning
        ...
        this.testTopology.tableOutput("sample-pair-topic").withSerde(Serdes.String(),Serdes.String()).expectNextRecord().isPresent();
